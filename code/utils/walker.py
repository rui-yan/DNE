...
from .utils_graph import partition_num
...
class RandomWalker:
    ...
    def simulate_walks(self, num_walks, walk_length, workers=1, verbose=0):
        ''' This method performs multiple random walks on the graph and returns a list of 
            all the random walks generated. The parameter num_walks specifies the number of 
            random walks to perform, and walk_length specifies the length of each random walk.
        '''
